...
#import "FLTCVideoPlayerPlugin.h"
...
@interface FLTCVideoPlayerPlugin () <FLTVideoPlayerApi>
...
@implementation FLTCVideoPlayerPlugin
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
  FLTCVideoPlayerPlugin* instance = [[FLTCVideoPlayerPlugin alloc] initWithRegistrar:registrar];
